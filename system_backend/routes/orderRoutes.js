import {createCustomOrder, getAllOrder, getAllOrders, getCustomOrders, getOrderByCustomerId, getOrdersByCustomerId, processPayment, updateAmountPaid, updateNewOrderStatus, updateOrderStatus} from '../controllers/orderController.js';
...
OrderRoutes.get('/all_orders',getAllOrder);
